...
public class PartyRecyclerAdapter extends RecyclerView.Adapter<PartyRecyclerAdapter.ViewHolder> {
    ...
    private RealmResults<PartyAudio> audioList;
    private Utilities utilities;
    private PlayListOnClickListener onClickListener;

    public PartyRecyclerAdapter(PlayListOnClickListener listener, RealmResults<PartyAudio> audios) {
        onClickListener = listener;
        audioList = audios;
    }

    @Override
    public PartyRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final PartyRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onClickListener != null) {
                    onClickListener.OnPartyClick(audioList, holder.getAdapterPosition());
                }
            }
        });
    ...
    private void delete(int position) {
        ...
        audioList = realm.where(PartyAudio.class).findAll();
        realm.beginTransaction();
        PartyAudio song = audioList.get(position);
