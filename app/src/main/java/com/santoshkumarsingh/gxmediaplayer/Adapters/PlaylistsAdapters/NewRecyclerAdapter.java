...
public class NewRecyclerAdapter extends RecyclerView.Adapter<NewRecyclerAdapter.ViewHolder> {
    ...
    private RealmResults<NewAudio> audioList;
    private Utilities utilities;
    private PlayListOnClickListener onClickListener;

    public NewRecyclerAdapter(PlayListOnClickListener listener, RealmResults<NewAudio> audios) {
        onClickListener = listener;
        audioList = audios;
    }

    @Override
    public NewRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final NewRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onClickListener != null) {
                    onClickListener.OnNewClick(audioList, holder.getAdapterPosition());
                }
            }
        });
    ...
    private void delete(int position) {
        ...
        audioList = realm.where(NewAudio.class).findAll();
        realm.beginTransaction();
        NewAudio song = audioList.get(position);
