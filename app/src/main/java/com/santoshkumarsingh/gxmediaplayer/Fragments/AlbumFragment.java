...
import com.santoshkumarsingh.gxmediaplayer.Adapters.AlbumRecyclerAdapter;
import com.santoshkumarsingh.gxmediaplayer.Interfaces.ItemOnClickListener;
import com.santoshkumarsingh.gxmediaplayer.Models.Album;
...
public class AlbumFragment extends android.support.v4.app.Fragment implements ItemOnClickListener {
    ...
    @Override
    public void OnItemClick(String AlbumID) {
        Toast.makeText(getContext(), "OK " + AlbumID, Toast.LENGTH_LONG).show();
        mListener.onAlbumFragmentInteraction(AlbumID);
    ...
    public interface OnFragmentInteractionListener {
        void onAlbumFragmentInteraction(String id);
