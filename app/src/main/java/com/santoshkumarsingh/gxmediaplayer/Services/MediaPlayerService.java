package com.santoshkumarsingh.gxmediaplayer.Services;
...
import com.santoshkumarsingh.gxmediaplayer.Activities.MainActivity;
...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private int resumePosition = 0, repeat = 0;
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(this)
                ...
                .addAction(android.R.drawable.ic_delete, "close", playbackAction(4));
    ...
    private void callStateListener() {
        ...
        phoneStateListener = new PhoneStateListener() {
            ...
            public void onServiceStateChanged(ServiceState serviceState) {
                ...
                if (playerStop) {
                    if (mediaPlayer != null || !isPlayerStop()) {
                        stopMedia();
                    }
                }
            }
